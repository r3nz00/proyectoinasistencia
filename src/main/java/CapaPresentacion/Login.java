...
public class Login extends javax.swing.JFrame {
    Fachadainasistencias fachadaina = new Fachadainasistencias();
   ...
   private void limpiar() {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String contrasenia = new String(fieldContrasena.getPassword());
        ...
        boolean valido = persistencia.iniciarSesion(cedula, contrasenia);
        
        if (valido) {
            JOptionPane.showMessageDialog(null, "Inicio de sesion exitoso.");
            limpiar();
            dispose(); // cierro la ventana actual
            PagAdmin in = new PagAdmin(); // abro la otra ventana
            in.setVisible(true);
